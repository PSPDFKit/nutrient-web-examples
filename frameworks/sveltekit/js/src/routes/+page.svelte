<script>
import NutrientLogo from "$lib/components/logos/NutrientLogo.svelte";
import SvelteLogo from "$lib/components/logos/SvelteLogo.svelte";
...
<svelte:head>
  <title>Nutrient Web SDK - SvelteKit JavaScript Examples</title>
</svelte:head>
