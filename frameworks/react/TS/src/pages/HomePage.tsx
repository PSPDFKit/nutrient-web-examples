  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
      <header style={{ textAlign: 'center', marginBottom: '3rem' }}>
        <h1>Nutrient Web SDK - React TypeScript Examples</h1>
        <p style={{ fontSize: '1.1rem', color: '#666' }}>
          Explore different ways to integrate Nutrient Web SDK with React and TypeScript
        </p>
      </header>
