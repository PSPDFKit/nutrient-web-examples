...
import { NutrientLogoComponent } from "../../components/logos/nutrient-logo.component";
          ...
          <div class="homepage-tech-stack">
            <div class="tech-item">
              <a
                ...
                class="link-no-style"
              >
                <app-nutrient-logo></app-nutrient-logo>
              </a>
            </div>
        ...
        <div class="examples-grid">
          <div *ngFor="let example of examples" class="example-card">
            ...
            <ul class="features-list">
              <li *ngFor="let feature of example.features">{{ feature }}</li>
            </ul>
